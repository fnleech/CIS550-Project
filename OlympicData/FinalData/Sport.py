...
import csv
rows = []
with open('C:\Studying Folder\CIS 550\pj\CIS550-Project\OlympicData\FinalData\Sport_v2.csv', 'rb') as csvfile:
...
cursor.prepare('insert into ' + database_table_name + ' (Discipline, Event) values (:1, :2)')
