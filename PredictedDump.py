...
import csv
rows = []
with open('C:\Studying Folder\CIS 550\pj\CIS550-Project\FinalData\Predicted.csv', 'rb') as csvfile:
...
port = 1521
SID = 'PENNDB'
database_table_name = 'CASEPREDICT'
dsn = cx_Oracle.makedsn(host, port, SID)
connection = cx_Oracle.connect('cis550project', 'cis550projectkeyPENN', dsn)
cursor = cx_Oracle.Cursor(connection)
cursor.prepare('insert into ' + database_table_name + ' (StateCode, Predict) values (:1, :2)')
